							...
							>
								<div className="h-2/3 flex flex-col justify-between items-center">
									...
									<div className="h-2/3 flex flex-col justify-around">
										...
										<Link href="/">
											<button className="h-10 w-full bg-black text-white rounded-md text-sm">Log In</button>
										</Link>
										<Link href="/">
											<button className="h-10 w-full text-black text-sm mb-6 border border-black hover:bg-black hover:text-white transition-all rounded-md">
												Continue as guest
											</button>
										</Link>
									</div>
