                ...
                <div className="mt-5 flex w-full flex-wrap">
                    {
                        ...
                        images.map(image => {
                            return(
                                <div key={image} className="w-1/4-m-1 m-1 bg-gray-300 h-44 cursor-pointer hover:border-black hover:border hover:shadow-md flex items-center justify-center rounded-lg">
                                    {image}
                                </div>
                            )
                        })
