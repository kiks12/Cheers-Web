        ...
        <>
            <div className="w-full flex flex-col items-center">
                ...
                <Link href="page/Bar-name/overview">
                    <div className="cursor-pointer h-72 w-full rounded-2xl p-4 flex justify-between mt-1 shadow-lg hover:w-full-hover hover:shadow-2xl hover:h-80 transition-all relative featured"
                        style={{
