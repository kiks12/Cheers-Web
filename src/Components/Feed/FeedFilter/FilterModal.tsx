...
const FilterModal : React.FC<FilterModalProps> = ({showFilterModal, setShowFilterModal}) => {
    return (
        <div className="fixed w-screen h-screen bg-black top-0 z-20 bg-opacity-60 px-10 py-10 items-center justify-center transition-all"
            style={{
