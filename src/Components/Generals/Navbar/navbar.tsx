    ...
    <nav
      ...
      <ul className='lg:flex md:flex sm:hidden justify-end w-1/4 h-full'>
        <Link href='/'>
          {activePage === "home" ? (
            <li
              className={ACTIVE_NAVBAR_LINK_STYLING}
              onClick={() => setActivePage("home")}>
              <MdOutlineHome size={24} />
            </li>
          ) : (
            <li
              className={INACTIVE_NAVBAR_LINK_STYLING}
              onClick={() => setActivePage("home")}>
              <MdOutlineHome size={24} />
            </li>
          )}
          ...
          <>
            ...
            <div className='flex items-center relative'>
              <div
                ...
                onClick={() =>
                  handleSettingsPopUpClick(
                    setShowSettingsPopUp,
                    setCurrentActiveSettings
                  )
                }>
      ...
      <div className='lg:hidden md:hidden sm:flex items-center'>
        ...
        {showFullScreenNavBar && (
          <NavBarFullScreen setShowNavBarFullScreen={setShowFullScreenNavBar} />
        )}
        <div
